...
args = {
    "config_file": "../RegionCLIP/configs/LVISv1-InstanceSegmentation/CLIP_fast_rcnn_R_50_C4_zsinf.yaml",
    "opts":[
    "MODEL.WEIGHTS", "../RegionCLIP/pretrained_ckpt/regionclip/regionclip_pretrained-cc_rn50.pth",
    "MODEL.CLIP.OFFLINE_RPN_CONFIG", "../RegionCLIP/configs/LVISv1-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml",
    "MODEL.CLIP.BB_RPN_WEIGHTS", "../RegionCLIP/pretrained_ckpt/rpn/rpn_lvis_866.pth",
    "INPUT_DIR", "../RegionCLIP/datasets/custom_images",
    "OUTPUT_DIR", "../RegionCLIP/output/region_feats"]
}
