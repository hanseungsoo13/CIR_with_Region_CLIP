...
class ModifiedResNet(Backbone):
    ...
    def __init__(self, layers, output_dim, heads, input_resolution=224, width=64, 
        out_features=None, freeze_at=0, depth=None, pool_vec=True, create_att_pool=True, norm_type='FronzenBN'):
        super().__init__()
...
def build_clip_resnet_backbone(cfg, input_shape):
    ...
    create_att_pool = True if (cfg.MODEL.ROI_HEADS.NAME in ['CLIPRes5ROIHeads', 'CLIPStandardROIHeads'])\
